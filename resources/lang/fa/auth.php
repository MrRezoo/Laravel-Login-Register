...
return [
    ...
    'two factor is inactive' => 'قابلیت احراز هویت دو مرحله‌ای برای شما فعال نمیباشد، شماره تلفن ثبت شده در سیستم ما برای شما :number میباشد
    ...
    'twoFactorActivated' => 'احراز هویت دو مرحله ای با موفقیت برای شما فعال شد.',
    'two factor is active' => 'احراز هویت دو مرحله ای برای شما برروی شماره تلفن :number فعال میباشد، جهت غیرفعال کردن این قابلیت میتوانید برروی دکمه زیر کلیک کنید.',
    'deactivate' => 'لغو کردن',
    'twoFactorDeactivated' => 'احراز هویت دو مرحله ای با موفقیت غیرفعال شد.',
    'activate' => 'فعال سازی',
